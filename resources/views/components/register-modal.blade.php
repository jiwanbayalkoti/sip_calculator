                    ...
                    <div class="w-full">
                        ...
                        <form id="registerForm" method="POST" action="{{ route('register') }}" class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="error-name text-red-500 text-sm mt-1"></div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="error-email text-red-500 text-sm mt-1"></div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="error-password text-red-500 text-sm mt-1"></div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="error-password_confirmation text-red-500 text-sm mt-1"></div>
                            </div>
